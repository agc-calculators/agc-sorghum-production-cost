...
class AgcSorghumProductionCost {
    constructor() {
        this.socket = "";
        this.tract = "";
        this.mode = "step";
        this.units = { land: "acre", yield: "bu/acre", sorghum: "bu" };
        this.currentStep = 0;
        this.cache = {};
    ...
    render() {
        return (h("div", null,
            h("form", { onSubmit: e => e.preventDefault(), ref: c => (this.form = c), "data-wizard": "agc-sorghum-production-cost", "data-wizard-mode": this.mode, class: "agc-wizard" },
                h("slot", null),
                h("section", { "data-wizard-section": "0" },
                    h("div", { class: "agc-wizard__field" },
                        h("label", { "data-i18n": "fields.market-price" }, "Expected Market Price"),
                        ...
                        h("p", { "data-i18n": `hints.market-price.${this.units["sorghum"]}` }, "\u2BA4 Enter the expected market price for sorghum per bushel.")),
    ...
    showResults() {
        ...
        let totalBushels = round(plantedAcres * expectedYield, 0);
        let results = {
            socket: this.socket,
            tract: this.tract,
            units: this.units,
    ...
    static get is() { return "agc-sorghum-production-cost"; }
...
export { AgcSorghumProductionCost };
