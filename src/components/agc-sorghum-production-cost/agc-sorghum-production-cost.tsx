...
@Component({
  tag: "agc-sorghum-production-cost"
})
export class AgcSorghumProductionCost {
  @Prop() socket: string = "";
  @Prop() tract: string = "";
  @Prop() mode: "full" | "step" = "step";
  @Prop() units: any = { land: "acre", yield: "bu/acre", sorghum: "bu" };
  @State() currentStep = 0;
  @State() cache = {};
    ...
    return (
      <div>
        <form
          ...
          data-wizard="agc-sorghum-production-cost"
        ...
        >
          ...
          <section data-wizard-section="0">
            <div class="agc-wizard__field">
              ...
              <p data-i18n={`hints.market-price.${this.units["sorghum"]}`}>
                ⮤ Enter the expected market price for sorghum per bushel.
              </p>
            </div>
